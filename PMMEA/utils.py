...
def align_embedding(data_name,adj1 ,adj2 , adj_matrix, index1,index2, nodes1, nodes2,K_nei, dim=128,use_method="netmf"):




    path1 = f"{data_name}_e1.npy"
    path2  = f"{data_name}_e2.npy"
